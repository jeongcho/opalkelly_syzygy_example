...
HD_PWD='D:/Work/opalkelly_syzygy/adc/Vivado-LTC2264-12/SZG-ADC-LTC2264-12.runs/enc_clk_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log enc_clk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source enc_clk.tcl
